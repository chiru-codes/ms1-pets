...
def get_status(pet_id: int, db: Session = Depends(get_db_session)):
...
def update_status(pet_id: int, status_update: AdoptionStatusUpdate, db: Session = Depends(get_db_session)):
...
def delete_status(pet_id: int, db: Session = Depends(get_db_session)):
